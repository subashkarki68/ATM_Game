...
//        this.mArrayOfCharacterNames = arrayOfCharacterNames;
    }
...
//            characters.add(allCharactersList.get(arr[i]));
            characters.add(new Character(R.drawable.ic_char_female_1, mCharName(arrayOfCharNames,i), "Nepal", "Suji", "Game"));
            Log.d("CheckCrash", "buildAllocatedCharacterList: " + String.valueOf(i));
        }
    }
